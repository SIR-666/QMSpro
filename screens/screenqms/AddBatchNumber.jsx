...
const AddBatchNumber = ({ navigation }) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await axios.post("http://10.24.0.82:5008/api/updateBatchNumber", {
        ...
        Production_Date: selectedItem?.Production_Date,
        Expiry_Date: selectedItem?.Expiry_Date,
        Filler: selectedItem?.Filler,
        Start_Production: selectedItem?.Start_Production,
        Last_Production: selectedItem?.Last_Production,
        Product_Size: selectedItem?.Product_Size,
      });
      ...
      console.error("Failed to update batch number:", error);
      alert("Failed to update batch number. Please try again.");
    }
  };
  ...
  return (
    ...
    <View style={styles.container}>
      ...
      <Text style={styles.headText}>ADD BATCH NUMBER</Text>
