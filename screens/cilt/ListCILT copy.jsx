...
const ListCILT = ({ navigation }) => {
  ...
  const filteredData = dataGreentag.filter(
    (item) => item.date.toString().includes(searchQuery)
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        <View style={styles.content}>
          ...
          <Text style={styles.sectionTitle}>Data CILT</Text>
          {nonDrafts.map((item, index) => (
            <View key={index}>
              <Text style={styles.infoTagNo}>{item.id}</Text>
              <View style={styles.section}>
                <Text style={styles.infoText}>Process Order</Text>
              ...
              <View style={styles.section}>
                <Text style={styles.infoText}>Batch</Text>
