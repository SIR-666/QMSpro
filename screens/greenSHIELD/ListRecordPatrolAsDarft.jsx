...
const ListRecordPatrolAsDarft = ({ navigation }) => {
  ...
  const fetchDataFromAPI = async () => {
    ...
    try {
      ...
      console.log(apiUrl);
      const response = await axios.get(`${apiUrl}/getAllRecordPatrolAsDraft`);
  ...
  const handleDetailPress = (item) => {
    navigation.navigate("EditchecklistPatrol", { recordPatrol: item });
  };
    ...
    return (
      <SafeAreaView style={styles.container}>
        <View style={styles.header}>
          <Text style={styles.title}>Record Patroli As Draft</Text>
          <Searchbar
            ...
            >
              ...
              <View style={styles.section}>
                ...
                <Text style={styles.infoText}>
                  {moment(item.jam_patroli_start).format("YYYY-MM-DD / HH:mm")}
                </Text>
              </View>
              ...
              <View style={styles.section}>
                ...
                <Text style={styles.infoText}>
                  {moment(item.jam_patroli_end).format("YYYY-MM-DD / HH:mm")}
                </Text>
              </View>
            </TouchableOpacity>
          ))}
...
export default ListRecordPatrolAsDarft;
